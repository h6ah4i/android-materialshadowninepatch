...
pushd drawable-ldpi
../../gen_alias_xml.py $res_prefix"ambient_shadow" $num_drawables 1
../../gen_alias_xml.py $res_prefix"spot_shadow" $num_drawables 1
popd
...
pushd drawable-hdpi
../../gen_alias_xml.py $res_prefix"ambient_shadow" $num_drawables 2
../../gen_alias_xml.py $res_prefix"spot_shadow" $num_drawables 2
popd
...
../../gen_alias_xml.py $res_prefix"ambient_shadow" $num_drawables 3
../../gen_alias_xml.py $res_prefix"spot_shadow" $num_drawables 3
popd

# xxxhdpi x4.0
mkdir drawable-xxxhdpi || true
pushd drawable-xxxhdpi
../../gen_alias_xml.py $res_prefix"ambient_shadow" $num_drawables 4
../../gen_alias_xml.py $res_prefix"spot_shadow" $num_drawables 4
popd
